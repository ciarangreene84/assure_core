...
namespace Assure.Core.RepositoryLayer.Tests.Integration.TestModels
{
    public class CmdpRequest : Request
    {
        public string Property00 { get; set; }
        public int Property10 { get; set; }
    }

    public class GenerisRequest : Request
    {
        public decimal Property20 { get; set; }
        public decimal Property21 { get; set; }
    }

    public class EndurRequest : Request
    {
